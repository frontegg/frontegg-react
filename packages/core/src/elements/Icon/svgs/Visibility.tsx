...
export const VisibilityOff = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
  ...
  return (
    <svg
      ...
      className={classNames('fe-icon', className)}
    >
		<path d="M256.011,106.673c-131.435,0-248.555,136.619-253.483,142.443c-3.371,3.968-3.371,9.792,0,13.781
			c2.944,3.477,45.995,53.461,108.075,93.269l66.859-66.859c-4.352-10.24-6.784-21.483-6.784-33.301
			c0-47.061,38.272-85.333,85.333-85.333c11.819,0,23.061,2.432,33.301,6.784l54.976-54.976
			C317.493,112.902,288.075,106.673,256.011,106.673z"/>

		<path d="M510.112,249.926c-2.731-3.947-48.021-67.691-124.16-108.779l58.944-58.944c4.16-4.16,4.16-10.923,0-15.083
