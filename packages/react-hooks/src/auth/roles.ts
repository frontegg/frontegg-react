import { rolesReducers, rolesActions, RolesActions, RolesState } from '@frontegg/redux-store/auth';
...
export const useRolesState: StateHookFunction<RolesState> = <S extends object>(stateMapper?: RolesStateMapper<S>): S =>
  stateHookGenerator(stateMapper, 'rolesState');
