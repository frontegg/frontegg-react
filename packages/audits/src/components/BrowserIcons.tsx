...
interface IBrowserIcon {
  width?: number;
  height?: number;
}

const Postman: FC<IBrowserIcon> = ({ width = 32, height = 32 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} viewBox='0 0 64 64'>
    ...
    <path d='M42.793 20.388L29.3 33.988l-3.813-3.92c13.28-13.28 14.613-12.08 17.307-9.68z' fill='#fff' />
    <path
      ...
      fill='#ff6c37'
    />
    <path d='M33.167 37.748l-3.68-3.76L42.98 20.654c3.627 3.547-1.76 9.467-9.813 17.093z' fill='#fff' />
    <path
    ...
    <path
      ...
      fill='#ff6c37'
    />
    <path d='M30.74 35.32l-3.76.48a.48.48 0 0 1-.453-.8l1.947-1.947z' fill='#fff' />
    <path
...
const Axios: FC<IBrowserIcon> = ({ width = 32, height = 32 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} viewBox='0 0 64 64'>
    <path
...
const Python: FC<IBrowserIcon> = ({ width = 32, height = 32 }) => (
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} version='1.0' viewBox='0 0 110.4211 109.8461'>
    <defs />
    <defs>
      <linearGradient id='a'>
      ...
      <linearGradient id='d' x1='89.137' x2='147.777' y1='111.921' y2='168.101' gradientUnits='userSpaceOnUse' />
      <linearGradient id='b'>
        <stop offset='0' stop-color='#387eb8' />
        <stop offset='1' stop-color='#366994' />
      </linearGradient>
      <linearGradient id='c' x1='55.549' x2='110.149' y1='77.07' y2='131.853' gradientUnits='userSpaceOnUse' />
    </defs>
    <g color='#000'>
      <path
...
export type TBrowserIcons = 'axios' | 'python' | 'postman';

export const browserIcons: Record<TBrowserIcons, FC<IBrowserIcon>> = {
  axios: Axios,
  python: Python,
  postman: Postman,
};
