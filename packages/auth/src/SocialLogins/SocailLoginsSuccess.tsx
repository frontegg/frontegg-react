...
import { ISocialLoginCallbackState } from './types';
...
export const SocialLoginsSuccess: FC = () => {
  const { routes, onRedirectTo, resetSocialLoginsState, setSocialLoginError, loginViaSocialLogin, socialLoginsState } = useAuth()
