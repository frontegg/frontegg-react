...
export interface AcceptInvitationFailedRedirectProps {
  renderer?: RendererFunctionFC<AcceptInvitationFailedRedirectProps>;
}

export const AcceptInvitationFailedRedirect: FC<AcceptInvitationFailedRedirectProps> = (props) => {
