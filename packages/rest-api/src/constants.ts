...
export const IDENTITY_API_TOKENS_TENANTS_SERVICE_V1 = '/identity/resources/tenants/api-tokens/v1';
export const IDENTITY_API_TOKENS_TENANTS_SERVICE_V2 = '/identity/resources/tenants/api-tokens/v2';
